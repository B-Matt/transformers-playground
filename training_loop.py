...
training_setups = [
    r'./.venv/bin/python hugging-trainer.py --epochs=2 --batch-size=46 --patch-size=256 --lr=1e-3',
    #r'./.venv/bin/python hugging-trainer.py --epochs=500 --batch-size=4 --patch-size=640 --lr=1e-3',
    #r'./.venv/bin/python hugging-trainer.py --epochs=5 --batch-size=4 --patch-size=800 --lr=1e-3',
