...
training_setups = [
    r'torchrun --nproc_per_node 2 hugging-trainer.py --name="MaskFormer" --model="facebook/maskformer-swin-tiny-ade" --epochs=500 --batch-size=46 --patch-size=256 --lr=1e-3',
    ...
    #r'torchrun --nproc_per_node 2 hugging-trainer.py --name="MaskFormer" --model="facebook/maskformer-swin-tiny-ade" --epochs=500 --batch-size=4 --patch-size=800 --lr=1e-3',
