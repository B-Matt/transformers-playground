    ...
    for type in dataset_types:
        ...
        for i, img in pbar:
            ...
            with torch.no_grad():
                ...
                masks_pred = torch.nn.functional.interpolate(outputs.logits, size=data['image'].shape[-2:], mode="bilinear", align_corners=False)[1]
                masks_pred = masks_pred.squeeze(0).cpu().numpy() * 255.0
